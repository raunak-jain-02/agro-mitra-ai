...
const MarketAnalysis = () => {
  ...
  useEffect(() => {
    const fetchMarketData = async () => {
      try {
        const response = await axios.get('https://api.data.gov.in/resource/9ef84268-d588-465a-a308-a864a43d0070?api-key=579b464db66ec23bdd000001bf80db6f209c43a45e82ccb60bc016a4&format=json&offset=0&limit=10');
